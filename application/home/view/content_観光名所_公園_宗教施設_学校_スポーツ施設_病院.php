      ...
      if (map == undefined){
        ...
        if(zoom != 0){
          ...
          mapProp = {
            ...
            styles: [
            {   featureType: 'poi.attraction',stylers: [{ visibility: 'off' }] },         //観光名所
            {    featureType: 'poi.park',stylers: [{ visibility: 'off' }] },              //公園
            {   featureType: 'poi.place_of_worship',stylers: [{ visibility: 'off' }] },   //宗教施設
            {   featureType: 'poi.school',stylers: [{ visibility: 'off' }] },             //学校
            {   featureType: 'poi.sports_complex',stylers: [{ visibility: 'off' }] },     //スポーツ施設
            {   featureType: 'poi.medical',stylers: [{ visibility: 'off' }] }             //病院、薬局、警察、医師などの緊急サービス
            ],
